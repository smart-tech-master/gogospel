<template>
  <div>
    ...
    <v-form v-if="!isSuccess" v-model="valid" method="POST" enctype="multipart/form-data" @submit.prevent="onSubmit">
      ...
      <v-col cols="12" class="pa-0">
        <p class="text-body-2">
          Upload a short video blurb about yourself. This video will appear in your profile.
        </p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      submitFormData() {
        this.isSaving = true
        this.$axios.post('/v1/auth/register', this.profile, {
          headers: {
